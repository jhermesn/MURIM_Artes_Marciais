...
export default function Registro() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      try {
        const result = await register(formData.name, formData.email, formData.telefone, formData.password)
        ...
        setRegisterError("Ocorreu um erro durante o registro. Tente novamente.")
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Junte-se à comunidade MURIM Artes Marciais</p>
          </div>
